export const Conclusion = ({ sectionLabel, title, description, image }) => {
  ...
  return (
    <section className="project-section conclusion-section" style={{ display: 'flex', alignItems: 'center', gap: '3rem' }}>
      ...
      <div className="split-section-right" style={{ flex: 1 }}>
        {image ? (
          <img src={image} alt="Conclusion" style={{ maxWidth: '100%', borderRadius: '4px' }} />
        ) : (
